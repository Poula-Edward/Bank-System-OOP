...
public:
    clsString() // default constraactor
    {
        _Value = "";
    }

    clsString(string Value)  // paramiterized costractor
    {
        _Value = Value;
    }
    ...
    static short CountWordInTheString(string S1)
    {
        string delimeter = " ";
        string word;
        short position = 0;
    ...
    short CountWordInTheString()
    {
        return CountWordInTheString(_Value);
    }
